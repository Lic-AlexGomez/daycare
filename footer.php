 ...
 */
?>
<?php if( get_theme_mod( 'babysitting_day_care_hide_scroll',true) != '' || get_theme_mod( 'babysitting_day_care_backtotop_responsive',true) != '') { ?>
...
<footer role="contentinfo" id="footer">
  ...
  ?>
  <?php if (get_theme_mod('babysitting_day_care_footer_hide_show', true)){ ?>
  ...
  <?php } ?>  
  <?php endif; ?>
  <?php if (get_theme_mod('babysitting_day_care_copyright_hide_show', true)) {?>
    <div class="inner">
      <div class="container">
        <div class="copyright">
