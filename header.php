			...
			<div class="container">
	            ...
	            <?php endif; ?>
	              ...
	              <?php if ( ! empty( $blog_info ) ) : ?>
		            ...
		            <?php }?>
	            <?php endif; ?>
	            <?php if( get_theme_mod('babysitting_day_care_show_tagline',false) != ''){ ?>
	                <?php
	            ...
	            <div id="sidelong-menu" class="nav side-nav">
		          ...
		          <?php if( get_theme_mod( 'babysitting_day_care_facebook_url') != '') { ?>
		            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'babysitting_day_care_facebook_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('babysitting_day_care_facebook_icon','fab fa-facebook-f me-2')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook', 'babysitting-day-care' ); ?></span></a>
		          <?php } ?>
		          <?php if( get_theme_mod( 'babysitting_day_care_twitter_url') != '') { ?>
		            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'babysitting_day_care_twitter_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('babysitting_day_care_twitter_icon','fab fa-twitter me-2')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter', 'babysitting-day-care' ); ?></span></a>
		          <?php } ?>
		          <?php if( get_theme_mod( 'babysitting_day_care_insta_url') != '') { ?>
		            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'babysitting_day_care_insta_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('babysitting_day_care_insta_icon','fab fa-instagram me-2')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram', 'babysitting-day-care' ); ?></span></a>
		          <?php } ?>
		          <?php if( get_theme_mod( 'babysitting_day_care_pinterest_url') != '') { ?>
		            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'babysitting_day_care_pinterest_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('babysitting_day_care_pinterest_icon','fab fa-pinterest-p me-2')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Pinterest', 'babysitting-day-care' ); ?></span></a>
		          <?php } ?> 
		          <?php if( get_theme_mod( 'babysitting_day_care_youtube_url') != '') { ?>
		            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'babysitting_day_care_youtube_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('babysitting_day_care_youtube_icon','fab fa-youtube')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube', 'babysitting-day-care' ); ?></span></a>
		          <?php } ?>
		        </div>
					</div>
