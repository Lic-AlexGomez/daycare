...
function babysitting_day_care_customize_register( $wp_customize ) {	
	...
	$wp_customize->add_section( 'babysitting_day_care_theme_color_option', array( 
		'panel' => 'babysitting_day_care_panel_id', 
		'title' => esc_html__( 'Global Color Settings', 'babysitting-day-care' ) 
	) );

  	$wp_customize->add_setting( 'babysitting_day_care_theme_color', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'babysitting_day_care_theme_color', array(
  		'label' => 'Color Option',
	    'description' => __('One can change complete theme global color settings on just one click.', 'babysitting-day-care'),
	    'section' => 'babysitting_day_care_theme_color_option',
	    'settings' => 'babysitting_day_care_theme_color',
  	)));
	...
	$wp_customize->add_setting('babysitting_day_care_menu_padding',array(
		'default'=> 5,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_WP_Customize_Range_Control( $wp_customize,'babysitting_day_care_menu_padding',array(
		'label'	=> __('Menu Font Padding','babysitting-day-care'),
		'section'=> 'babysitting_day_care_header',
		'input_attrs' => array(
         'step'  => 1,
			'min'   => 0,
	...
	$wp_customize->add_setting('babysitting_day_care_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_menu_color', array(
		'label'    => __('Menu Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_header',
		'settings' => 'babysitting_day_care_menu_color',
	)));

	$wp_customize->add_setting('babysitting_day_care_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_menu_hover_color', array(
		'label'    => __('Menu Hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_header',
		'settings' => 'babysitting_day_care_menu_hover_color',
	)));

	$wp_customize->add_setting('babysitting_day_care_submenu_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_submenu_menu_color', array(
		'label'    => __('Submenu Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_header',
		'settings' => 'babysitting_day_care_submenu_menu_color',
	)));

	$wp_customize->add_setting('babysitting_day_care_submenu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_submenu_hover_color', array(
		'label'    => __('Submenu Hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_header',
		'settings' => 'babysitting_day_care_submenu_hover_color',
	)));

	$wp_customize->add_setting( 'babysitting_day_care_menu_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('babysitting_day_care_menu_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            <ul>
                <li>Menu DropDown Background Colors</li>
                <li>Menu Item Fonts</li>
                <li>Active Menu Colors</li>
                <li>Header Search Icons Colors</li>
                <li>... and Other Premium Features</li>
            </ul>
            <a target='_blank' href='". esc_url('https://www.themesglance.com/themes/day-care-wordpress-theme/') ." '>Upgrade Now</a>",
        'section' => 'babysitting_day_care_header'
        )
    );
	...
	$wp_customize->add_setting('babysitting_day_care_facebook_icon',array(
        'default'   => 'fab fa-facebook-f',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_facebook_icon',array(
        'label' => __('Facebook Icon','babysitting-day-care'),
        'section' => 'babysitting_day_care_social_media',
        'type'    => 'icon',
    )));
	...
	$wp_customize->add_setting('babysitting_day_care_twitter_icon',array(
        'default'   => 'fab fa-twitter',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_twitter_icon',array(
        'label' => __('Twitter Icon','babysitting-day-care'),
        'section' => 'babysitting_day_care_social_media',
        'type'    => 'icon',
    )));
	...
	$wp_customize->add_setting('babysitting_day_care_insta_icon',array(
        'default'   => 'fab fa-instagram',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_insta_icon',array(
        'label' => __('Instagram Icon','babysitting-day-care'),
        'section' => 'babysitting_day_care_social_media',
        'type'    => 'icon',
    )));
	...
	$wp_customize->add_setting('babysitting_day_care_pinterest_icon',array(
        'default'   => 'fab fa-pinterest-p',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_pinterest_icon',array(
        'label' => __('Pinterest Icon','babysitting-day-care'),
        'section' => 'babysitting_day_care_social_media',
        'type'    => 'icon',
    )));
	...
	$wp_customize->add_setting('babysitting_day_care_youtube_icon',array(
        'default'   => 'fab fa-youtube',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_youtube_icon',array(
        'label' => __('Youtube Icon','babysitting-day-care'),
        'section' => 'babysitting_day_care_social_media',
        'type'    => 'icon',
    )));

	$wp_customize->add_setting('babysitting_day_care_social_icons_font_size',array(
		'default'=> '15',
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float'
	));
	$wp_customize->add_control('babysitting_day_care_social_icons_font_size',array(
		'label'	=> __('Social Icons Font Size','babysitting-day-care'),
		'input_attrs' => array(
            'step' => 1,
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting('babysitting_day_care_slider_section_bg_image',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'babysitting_day_care_slider_section_bg_image',array(
		'label' => __('Slider Background Image','babysitting-day-care'),
		'section' => 'babysitting_day_care_slider'
	)));

	$wp_customize->add_setting( 'babysitting_day_care_slider_speed', array(
		'default'              => 3000,
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float'
	) );
	$wp_customize->add_control( 'babysitting_day_care_slider_speed', array(
		'label'       => esc_html__( 'Slider Speed','babysitting-day-care' ),
		'section'     => 'babysitting_day_care_slider',
		'type'        => 'number',
		'settings'    => 'babysitting_day_care_slider_speed',
		'input_attrs' => array(
			'step' => 500,
			'min'  => 500,
			'max'  => 5000,
	...
	$wp_customize->add_setting( 'babysitting_day_care_slider_arrow_hide_show',array(
	    'default' => true,   
	    'sanitize_callback' => 'babysitting_day_care_sanitize_checkbox'
	));
	$wp_customize->add_control( 'babysitting_day_care_slider_arrow_hide_show',array(
		'label' => esc_html__( 'Show / Hide Slider Arrows','babysitting-day-care' ),
		'section' => 'babysitting_day_care_slider',
		'type' => 'checkbox',
	));

	$wp_customize->add_setting('babysitting_day_care_slider_prev_icon',array(
		'default'	=> 'fas fa-long-arrow-alt-left',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_slider_prev_icon',array(
		'label'	=>__('Add Slider Prev Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_slider',
		'setting'	=> 'babysitting_day_care_slider_prev_icon',
		'type'		=> 'icon',
	)));

	$wp_customize->add_setting('babysitting_day_care_slider_next_icon',array(
		'default'	=> 'fas fa-long-arrow-alt-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new babysitting_day_care_Icon_Selector(
        $wp_customize,'babysitting_day_care_slider_next_icon',array(
		'label'	=> __('Add Slider Next Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_slider',
		'setting'	=> 'babysitting_day_care_slider_next_icon',
		'type'		=> 'icon',
	)));

	 $wp_customize->add_setting('babysitting_day_care_slider_arrows_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_slider_arrows_hover_color', array(
		'label'    => __('Slider Arrows hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_slider',
		'settings' => 'babysitting_day_care_slider_arrows_hover_color',
	)));
	...
	$wp_customize->add_setting('babysitting_day_care_slider_button_link',array(
        'default'=> '',
        'sanitize_callback' => 'esc_url_raw'
    ));
    $wp_customize->add_control('babysitting_day_care_slider_button_link',array(
        'label' => esc_html__('Add Button Link','babysitting-day-care'),
        'section'=> 'babysitting_day_care_slider',
        'type'=> 'url'
    ));

	$wp_customize->add_setting('babysitting_day_care_slider_btn_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_slider_btn_color', array(
		'label'    => __('Slider Button Lable Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_slider',
		'settings' => 'babysitting_day_care_slider_btn_color',
	)));

	$wp_customize->add_setting('babysitting_day_care_slider_btn_border_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_slider_btn_border_color', array(
		'label'    => __('Slider Button Border Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_slider',
		'settings' => 'babysitting_day_care_slider_btn_border_color',
	)));

	$wp_customize->add_setting( 'babysitting_day_care_slider_btn_border_radius', array(
		'default'=> '10',
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float'
	) );
	$wp_customize->add_control('babysitting_day_care_slider_btn_border_radius', array(
            'label'  => __('Slider Button Border Radius','babysitting-day-care'),
            'input_attrs' => array(
            	'step' => 1,
                'min' => 0,
                'max' => 50,
    ...
    $wp_customize->add_setting('babysitting_day_care_slider_btn_lable_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_slider_btn_lable_hover_color', array(
		'label'    => __('Slider Button Lable hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_slider',
		'settings' => 'babysitting_day_care_slider_btn_lable_hover_color',
	)));

	$wp_customize->add_setting('babysitting_day_care_slider_btn_bg_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_slider_btn_bg_hover_color', array(
		'label'    => __('Slider Button Bg hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_slider',
		'settings' => 'babysitting_day_care_slider_btn_bg_hover_color',
	)));

	$wp_customize->add_setting( 'babysitting_day_care_slider_height', array(
		'default'          => '',
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float'
	) );
	$wp_customize->add_control( 'babysitting_day_care_slider_height', array(
		'label' => esc_html__( 'Slider Height','babysitting-day-care' ),
		'section' => 'babysitting_day_care_slider',
		'type'    => 'number',
		'description' => __('Measurement is in pixel.','babysitting-day-care'),
		'input_attrs' => array(
	...
	$wp_customize->add_setting('babysitting_day_care_program_section_bg_image',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'babysitting_day_care_program_section_bg_image',array(
		'label' => __('Add Background Image','babysitting-day-care'),
		'section' => 'babysitting_day_care_services'
	)));

	$wp_customize->add_setting( 'babysitting_day_care_program_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('babysitting_day_care_program_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            <ul>
                <li>Title Font Settings</li>
                <li>Title Color Settings</li>
	...
	$wp_customize->add_control(new Babysitting_Day_Care_Image_Radio_Control($wp_customize, 'babysitting_day_care_layout', array(
   	...
   	$wp_customize->add_setting('babysitting_day_care_blog_post_alignment',array(
        'default' => 'center',
        'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
    ));
	$wp_customize->add_control('babysitting_day_care_blog_post_alignment', array(
        'type' => 'select',
        'label' => __( 'Blog Post Alignment', 'babysitting-day-care' ),
        'section' => 'babysitting_day_care_theme_layout',
        'choices' => array(
            'left' => __('Left Align','babysitting-day-care'),
            'right' => __('Right Align','babysitting-day-care'),
            'center' => __('Center Align','babysitting-day-care')
        ),
    ));
    ...
    $wp_customize->add_setting('babysitting_day_care_featured_image',array(
       'default' => 'true',
       'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
    ));
    $wp_customize->add_control('babysitting_day_care_featured_image',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Featured Image','babysitting-day-care'),
       'section' => 'babysitting_day_care_theme_layout'
    ));
    ...
    $wp_customize->add_setting('babysitting_day_care_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_theme_layout',
		'setting'	=> 'babysitting_day_care_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_postauthor_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_postauthor_icon',array(
		'label'	=> __('Add Post Author Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_postcomment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_postcomment_icon',array(
		'label'	=> __('Add Post Comments Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_posttime_icon',array(
		'label'	=> __('Add Post Time Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_theme_layout',
		'type'		=> 'icon'
	)));
	...
	//Featured Image
	$wp_customize->add_setting('babysitting_day_care_blog_image_dimension',array(
       'default' => 'default',
       'sanitize_callback'	=> 'babysitting_day_care_sanitize_choices'
    ));
    $wp_customize->add_control('babysitting_day_care_blog_image_dimension',array(
       'type' => 'radio',
       'label'	=> __('Blog Post Featured Image Dimension','babysitting-day-care'),
       'choices' => array(
            'default' => __('Default','babysitting-day-care'),
            'custom' => __('Custom Image Size','babysitting-day-care'),
        ),
      	'section'	=> 'babysitting_day_care_theme_layout',
    ));

    $wp_customize->add_setting( 'babysitting_day_care_feature_image_custom_width', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new Babysitting_Day_Care_WP_Customize_Range_Control( $wp_customize, 'babysitting_day_care_feature_image_custom_width', array(
        'label'  => __('Featured Image Custom Width','babysitting-day-care'),
        'section'  => 'babysitting_day_care_theme_layout',
        'description' => __('Measurement is in pixel.','babysitting-day-care'),
        'input_attrs' => array(
            'min' => 0,
		...
		'active_callback' => 'babysitting_day_care_blog_image_dimension'
    )));

    $wp_customize->add_setting( 'babysitting_day_care_feature_image_custom_height', array(
		'default'=> '250',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( new Babysitting_Day_Care_WP_Customize_Range_Control( $wp_customize, 'babysitting_day_care_feature_image_custom_height', array(
        'label'  => __('Featured Image Custom Height','babysitting-day-care'),
        'section'  => 'babysitting_day_care_theme_layout',
        'description' => __('Measurement is in pixel.','babysitting-day-care'),
        'input_attrs' => array(
            'min' => 0,
    ...
    $wp_customize->add_setting( 'babysitting_day_care_post_settings_premium_features',array(
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('babysitting_day_care_post_settings_premium_features', array(
        'type'=> 'hidden',
        'description' => "<h3>Premium Theme Features!</h3>
            <ul>
    ...
    $wp_customize->add_setting('babysitting_day_care_singlepost_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_singlepost_date_icon',array(
		'label'	=> __('Add Single Post Date Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_single_post_settings',
		'setting'	=> 'babysitting_day_care_singlepost_date_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_singlepost_author_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_singlepost_author_icon',array(
		'label'	=> __('Add Single Post Author Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_single_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_single_post_comment_icon',array(
		'label'	=> __('Add Single Post Comments Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('babysitting_day_care_single_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Babysitting_Day_Care_Icon_Selector(
        $wp_customize,'babysitting_day_care_single_post_time_icon',array(
		'label'	=> __('Add Single Post Time Icon','babysitting-day-care'),
		'transport' => 'refresh',
		'section'	=> 'babysitting_day_care_single_post_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('babysitting_day_care_single_post_metabox_seperator',array(
       'default' => '|',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('babysitting_day_care_single_post_metabox_seperator',array(
       'type' => 'text',
       'label' => __('Metabox Seperator','babysitting-day-care'),
       'description' => __('Ex: "/", "|", "-", ...','babysitting-day-care'),
       'section' => 'babysitting_day_care_single_post_settings'
    ...
    $wp_customize->add_control('babysitting_day_care_single_post_image',array(
     ...
     $wp_customize->add_setting('babysitting_day_care_single_post_category',array(
       'default' => 'true',
       'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
    ));
    $wp_customize->add_control('babysitting_day_care_single_post_category',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Single Post Category','babysitting-day-care'),
       'section' => 'babysitting_day_care_single_post_settings'
    ));
    ...
    $wp_customize->add_setting( 'babysitting_day_care_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float',
	) );
	$wp_customize->add_control( 'babysitting_day_care_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','babysitting-day-care' ),
		'section'     => 'babysitting_day_care_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'babysitting_day_care_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'babysitting_day_care_sanitize_float',
	));
	$wp_customize->add_control('babysitting_day_care_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','babysitting-day-care' ),
		'section' => 'babysitting_day_care_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting( 'babysitting_day_care_related_post_excerpt_number',array(
		'default' => 20,
		'sanitize_callback' => 'babysitting_day_care_sanitize_float'
	));

	$wp_customize->add_control('babysitting_day_care_related_post_excerpt_number',	array(
		'label' => esc_html__( 'Related Posts Content Limit','babysitting-day-care' ),
		'section' => 'babysitting_day_care_single_post_settings',
		'type'    => 'number',
	 	'settings' => 'babysitting_day_care_related_post_excerpt_number',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
    ...
    // font size button
 	$wp_customize->add_setting( 'babysitting_day_care_button_font_size',array(
		'default' => '16',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control( new babysitting_day_care_WP_Customize_Range_Control( $wp_customize, 'babysitting_day_care_button_font_size', array(
		'label'  => __('Button Font Size','babysitting-day-care'),
		'section'  => 'babysitting_day_care_button_options',
		'description' => __('Measurement is in pixel.','babysitting-day-care'),
		'input_attrs' => array(
		   'min' => 0,
 	...
 	$wp_customize->add_setting('babysitting_day_care_button_font_weight',array(
    'default' => '',
    'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
	));
	$wp_customize->add_control('babysitting_day_care_button_font_weight',array(
	    'type' => 'select',
	    'label' => __('Button Font Weight','babysitting-day-care'),
	    'section' => 'babysitting_day_care_button_options',
	    'choices' => array(
	       '100' => __('100','babysitting-day-care'),
	       '200' => __('200','babysitting-day-care'),
	...
	$wp_customize->add_setting('babysitting_day_care_button_text_transform',array(
        'default' => '',
        'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
  	));
  	$wp_customize->add_control('babysitting_day_care_button_text_transform',array(
        'type' => 'select',
        'label' => __('Button Text transform','babysitting-day-care'),
        'section' => 'babysitting_day_care_button_options',
        'choices' => array(
            'uppercase' => __('Uppercase','babysitting-day-care'),
            'capitalize' => __('Capitalize','babysitting-day-care'),
            'lowercase' => __('lowercase','babysitting-day-care'),
        ),
  	) );
    ...
    $wp_customize->add_setting( 'babysitting_day_care_preloader_color', array(
  	...
  	$wp_customize->add_setting('babysitting_day_care_preloader_bg_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'babysitting_day_care_preloader_bg_img',array(
        'label' => __('Preloader Background Image','babysitting-day-care'),
        'section' => 'babysitting_day_care_advance_options'
	)));
	...
	$wp_customize->add_setting( 'babysitting_day_care_single_page_breadcrumb',array(
		'default' => true,
      	'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
    ) );
    $wp_customize->add_control('babysitting_day_care_single_page_breadcrumb',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Single Page Breadcrumb','babysitting-day-care' ),
        'section' => 'babysitting_day_care_advance_options'
    ));

    $wp_customize->add_setting('babysitting_day_care_breadcrumb_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_breadcrumb_color', array(
		'label'    => __('Breadcrumb Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_advance_options',
	)));

	$wp_customize->add_setting('babysitting_day_care_breadcrumb_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_breadcrumb_background_color', array(
		'label'    => __('Breadcrumb Background Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_advance_options',
	)));

	$wp_customize->add_setting('babysitting_day_care_breadcrumb_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_breadcrumb_hover_color', array(
		'label'    => __('Breadcrumb Hover Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_advance_options',
	)));

	$wp_customize->add_setting('babysitting_day_care_breadcrumb_hover_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_breadcrumb_hover_bg_color', array(
		'label'    => __('Breadcrumb Hover Background Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_advance_options',
	)));
    ...
    $wp_customize->add_setting( 'babysitting_day_care_toggle_button_bg_color_settings', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'babysitting_day_care_toggle_button_bg_color_settings', array(
  		'label' => __('Toggle Button Bg Color', 'babysitting-day-care'),
	    'section' => 'babysitting_day_care_responsive_options',
	    'settings' => 'babysitting_day_care_toggle_button_bg_color_settings',
  	)));

    $wp_customize->add_setting('babysitting_day_care_sticky_header_responsive',array(
        'default' => false,
        'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
	));
	$wp_customize->add_control('babysitting_day_care_sticky_header_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Sticky Header','babysitting-day-care'),
      	'section' => 'babysitting_day_care_responsive_options',
	));
	...
	$wp_customize->add_setting('babysitting_day_care_slider_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
	));
	$wp_customize->add_control('babysitting_day_care_slider_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Slider','babysitting-day-care'),
      	'section' => 'babysitting_day_care_responsive_options',
	));

	$wp_customize->add_setting('babysitting_day_care_slider_button_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
	));
	$wp_customize->add_control('babysitting_day_care_slider_button_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Slider Button','babysitting-day-care'),
      	'section' => 'babysitting_day_care_responsive_options',
	));
	...
	$wp_customize->add_setting('babysitting_day_care_backtotop_responsive',array(
        'default' => true,
        'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
	));
	$wp_customize->add_control('babysitting_day_care_backtotop_responsive',array(
     	'type' => 'checkbox',
      	'label' => __('Enable Back to Top','babysitting-day-care'),
      	'section' => 'babysitting_day_care_responsive_options',
	));

	$wp_customize->add_setting( 'babysitting_day_care_sidebar_hide_show',array(
      'default' => true,
      'sanitize_callback'	=> 'babysitting_day_care_sanitize_checkbox'
    ));
    $wp_customize->add_control('babysitting_day_care_sidebar_hide_show',array(
      'type' => 'checkbox',
      'label' => esc_html__( 'Enable Sidebar','babysitting-day-care' ),
      'section' => 'babysitting_day_care_responsive_options'
    ));
    ...
    $wp_customize->add_setting('babysitting_day_care_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'babysitting_day_care_sanitize_choices',
	));
	$wp_customize->add_control('babysitting_day_care_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page layout', 'babysitting-day-care'),
		'section'        => 'babysitting_day_care_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'babysitting-day-care'),
			'Right Sidebar' => __('Right Sidebar', 'babysitting-day-care'),
    ...
    $wp_customize->add_setting('babysitting_day_care_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'babysitting_day_care_sanitize_choices',
	));
	$wp_customize->add_control('babysitting_day_care_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'babysitting-day-care'),
		'section'        => 'babysitting_day_care_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'babysitting-day-care'),
			'Right Sidebar' => __('Right Sidebar', 'babysitting-day-care'),
	...
	$wp_customize->add_setting('babysitting_day_care_back_to_top_text_color', array(
		'default'           => '#000',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_back_to_top_text_color', array(
		'label'    => __('Back To Top Text Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_footer_section',
	)));

	$wp_customize->add_setting( 'babysitting_day_care_footer_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'babysitting_day_care_sanitize_checkbox'
    ));
    $wp_customize->add_control('babysitting_day_care_footer_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Footer','babysitting-day-care' ),
      'section' => 'babysitting_day_care_footer_section'
    ));
    ...
    $wp_customize->add_setting('babysitting_day_care_widgets_heading_fontsize',array(
		'default'	=> 25,
		'sanitize_callback'	=> 'babysitting_day_care_sanitize_float',
	));	
	$wp_customize->add_control('babysitting_day_care_widgets_heading_fontsize',array(
		'label'	=> __('Footer Widgets Heading Font Size','babysitting-day-care'),
		'section'	=> 'babysitting_day_care_footer_section',
		'type'		=> 'number'
	));

	$wp_customize->add_setting('babysitting_day_care_widgets_heading_font_weight',array(
        'default' => '600',
        'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
    ));
    $wp_customize->add_control('babysitting_day_care_widgets_heading_font_weight',array(
        'type' => 'select',
        'label' => __('Footer Widgets Heading Font Weight','babysitting-day-care'),
        'section' => 'babysitting_day_care_footer_section',
        'choices' => array(
            '100' => __('100','babysitting-day-care'),
            '200' => __('200','babysitting-day-care'),
    ...
    $wp_customize->add_setting('babysitting_day_care_footer_widgets_heading',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
	));
	$wp_customize->add_control('babysitting_day_care_footer_widgets_heading',array(
    'type' => 'select',
    'label' => __('Footer Widget Heading Alignment','babysitting-day-care'),
    'section' => 'babysitting_day_care_footer_section',
    'choices' => array(
    	'Left' => __('Left','babysitting-day-care'),
        'Center' => __('Center','babysitting-day-care'),
	...
	$wp_customize->add_setting('babysitting_day_care_footer_widgets_content',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'babysitting_day_care_sanitize_choices'
	));
	$wp_customize->add_control('babysitting_day_care_footer_widgets_content',array(
    'type' => 'select',
    'label' => __('Footer Widget Content Alignment','babysitting-day-care'),
    'section' => 'babysitting_day_care_footer_section',
    'choices' => array(
    	'Left' => __('Left','babysitting-day-care'),
        'Center' => __('Center','babysitting-day-care'),
    ...
    $wp_customize->add_setting( 'babysitting_day_care_copyright_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'babysitting_day_care_sanitize_checkbox'
    ));
    $wp_customize->add_control('babysitting_day_care_copyright_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Copyright','babysitting-day-care' ),
      'section' => 'babysitting_day_care_footer_section'
    ));

    $wp_customize->add_setting('babysitting_day_care_copyright_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_copyright_bg_color', array(
		'label'    => __('Copyright Background Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_footer_section',
	)));

	$wp_customize->add_setting('babysitting_day_care_copyright_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'babysitting_day_care_copyright_color', array(
		'label'    => __('Copyright Color', 'babysitting-day-care'),
		'section'  => 'babysitting_day_care_footer_section',
	)));
		...
		$manager->add_section(
			...
			'babysitting_day_care_pro_link',
				array(
					...
					'pro_text' => esc_html__( 'Get Pro', 'babysitting-day-care' ),
