...
<main id="maincontent" role="main">
  ...
  <?php if(get_theme_mod('babysitting_day_care_show_slider') != ''  || get_theme_mod('babysitting_day_care_slider_responsive') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod('babysitting_day_care_slider_speed',3000)); ?>"> 
                    ...
                    <div class="carousel-caption">
                      <div class="inner_carousel">
                        ...
                        <?php if ( get_theme_mod('babysitting_day_care_slider_content',true) != '' ) {?>
                          <p><?php $babysitting_day_care_excerpt = get_the_excerpt(); echo esc_html( babysitting_day_care_string_limit_words( $babysitting_day_care_excerpt, esc_attr(get_theme_mod('babysitting_day_care_slider_excerpt','25')))); ?></p>
                        <?php }?>
                        <?php if(get_theme_mod('babysitting_day_care_slider_button',true) != '' || get_theme_mod('babysitting_day_care_slider_button_responsive',true) != ''|| get_theme_mod('babysitting_day_care_slider_button_link') != '') {?>
                          <?php if ( get_theme_mod('babysitting_day_care_slider_button_label','READ MORE') != '' ) {?>
                            <div class ="read-more mt-md-4 mt-0">
                              <a href="<?php echo esc_url(get_theme_mod('babysitting_day_care_slider_button_link')!= '') ? esc_url(get_theme_mod('babysitting_day_care_slider_button_link')) : esc_url(get_permalink()); ?>"><?php echo esc_html( get_theme_mod('babysitting_day_care_slider_button_label',__('READ MORE','babysitting-day-care')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('babysitting_day_care_slider_button_label',__('READ MORE','babysitting-day-care')) ); ?></span></a>
                            </div>
                          <?php }?>
                        <?php }?>
                      </div>
        ...
        <?php if(get_theme_mod('babysitting_day_care_slider_arrow_hide_show', true)){?>
          <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
            <span class="carousel-control-prev-icon py-1 px-3" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('babysitting_day_care_slider_prev_icon','fas fa-long-arrow-alt-left')); ?>"></i></span>
            <span class="screen-reader-text"><?php esc_html_e('Previous','babysitting-day-care'); ?></span>
          </a>
          <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
            <span class="carousel-control-next-icon py-1 px-3" aria-hidden="true"><i class="<?php echo esc_attr(get_theme_mod('babysitting_day_care_slider_next_icon','fas fa-long-arrow-alt-right')); ?>"></i></span>
                ...
                <div class="col-lg-4 col-md-4">
                  <div class="service-content my-4 <?php echo('service-content-bg').$bgcolor ?>">
                    ...
                    <div class="p-3">
                      ...
                      <p><?php $babysitting_day_care_excerpt = get_the_excerpt(); echo esc_html( babysitting_day_care_string_limit_words( $babysitting_day_care_excerpt,10) ); ?></p>
                    </div>
                  </div>
                </div>
