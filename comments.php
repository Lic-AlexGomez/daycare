...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				$babysitting_day_care_comments_number = get_comments_number();
				if ( 1 === $babysitting_day_care_comments_number ) {
					...
					printf(
					   	esc_html(
					     	...
					     	_nx( 
					          	...
					          	$babysitting_day_care_comments_number,
					          	'comments title',
					          	'babysitting-day-care'
					       	)
					   	),
					   	esc_html (number_format_i18n( $babysitting_day_care_comments_number ) ),
